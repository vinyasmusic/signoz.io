...
- Dream - It is an AI-generated art product similar to Stable Diffusion but much simpler to use.
...
Being a small team, we only have time to do a little testing. So instead, we test in production. We believe that our observability system should be good enough to address any issues quickly. This helps us be fast, and ship features to users faster.
